    ...
    case 'science':
      return (
        <Div color={includes()}>
          ...
          >
            <g>
              <path fill={includes()} d="M447.859,427.096c-12.386-14.759-112.847-134.465-124.517-148.373V73.564
		...
		c-22.557,0-34.804-26.233-20.294-43.524l62.219-74.138h220.686l62.219,74.138C443.065,460.567,430.844,486.811,408.271,486.811z"
              />
              <path fill={includes()} d="M317.221,389.978c-20.955,0-38.003,17.046-38.003,38.001c0,20.955,17.048,38.003,38.003,38.003
      ...
      return (
        <Div color={includes()}>
          ...
          >
            ...
            <line className="st0" x1="14.6" y1="11.3" x2="14" y2="1"/>
            <line className="st0" x1="20" y1="1" x2="19.4" y2="11.3"/>
            <path className="st0" d="M17,17c0,1,0,8,0,8"/>
            <line className="st0" x1="15" y1="25" x2="19" y2="25"/>
